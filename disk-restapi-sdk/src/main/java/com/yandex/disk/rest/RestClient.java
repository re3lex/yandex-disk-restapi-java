...
import static com.yandex.disk.rest.retrofit.ErrorHandlerImpl.throwHttpCodeException;
...
//            : Retrofit.LogLevel.NONE;
  ...
  public RestClient(@NonNull final Credentials credentials) {
    this(credentials, OkHttpClientFactory.makeClient(new RequestInterceptorImpl(credentials.getHeaders())));
  }
  public RestClient(@NonNull final Credentials credentials, @NonNull Interceptor interceptor) {
    this(credentials, OkHttpClientFactory.makeClient(interceptor, new RequestInterceptorImpl(credentials.getHeaders())));
  }
